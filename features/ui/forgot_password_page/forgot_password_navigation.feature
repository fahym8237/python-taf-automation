...
Feature: OpenCart Authentication - Forgotten Password Navigation
  ...
  @PAS-45 @PY-FPN-001 @smoke @trace=REQ-FPN-001
  ...
  @PAS-46 @PY-FPN-002 @navigation @trace=REQ-FPN-002
  ...
  @PAS-44 @PY-FPN-003 @navigation @trace=REQ-FPN-003
  ...
  @PAS-47 @PY-FPN-004 @navigation @trace=REQ-FPN-004
  ...
  @PAS-43 @PY-FPN-005 @navigation @trace=REQ-FPN-005
