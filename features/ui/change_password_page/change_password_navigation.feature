...
Feature: OpenCart Account - Change Password Navigation
  ...
  @PY-CPN-001 @smoke @trace=REQ-CPN-001
  ...
  @PY-CPN-002 @navigation @trace=REQ-CPN-002
  ...
  @PY-CPN-003 @navigation @trace=REQ-CPN-003
  ...
  @PY-CPN-004 @navigation @trace=REQ-CPN-004
  ...
  @PY-CPN-005 @navigation @trace=REQ-CPN-005
  ...
  @PY-CPN-006 @navigation @trace=REQ-CPN-006
