...
Feature: OpenCart Authentication - Login Page Session Management
  ...
  @PY-LPSE-001 @session @positive @trace=REQ-LPSE-001
  ...
  @PY-LPSE-002 @session @access_control @trace=REQ-LPSE-002
  ...
  @PY-LPSE-003 @session @access_control @trace=REQ-LPSE-003
  ...
  @PY-LPSE-004 @session @access_control @trace=REQ-LPSE-004
  ...
  @PY-LPSE-005 @session @positive @trace=REQ-LPSE-005
  ...
  @PY-LPSE-006 @session @positive @trace=REQ-LPSE-006
