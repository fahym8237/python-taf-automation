...
Feature: Booking API - CRUD
  ...
  @PYT-1 @smoke @trace=REQ-BOOKING-CRUD-001
  ...
  @PYT-2 @smoke @trace=REQ-BOOKING-CRUD-001
  ...
  @PYT-3 @smoke @trace=REQ-BOOKING-CRUD-001
  ...
  @PYT-4 @smoke @trace=REQ-BOOKING-CRUD-001
