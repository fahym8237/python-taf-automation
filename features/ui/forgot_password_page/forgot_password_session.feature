...
Feature: OpenCart Authentication - Forgotten Password Session Management
  ...
  @PAS-58 @PY-FPSE-001 @session @stability @trace=REQ-FPSE-001
  ...
  @PAS-59 @PY-FPSE-002 @session @navigation @trace=REQ-FPSE-002
  ...
  @PAS-60 @PY-FPSE-003 @session @stability @trace=REQ-FPSE-003
  ...
  @PAS-61 @PY-FPSE-004 @session @public_access @trace=REQ-FPSE-004
