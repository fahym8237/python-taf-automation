...
Feature: OpenCart Authentication - Register Page Session Management
  ...
  @PY-RPSE-001 @session @stability @trace=REQ-RPSE-001
  ...
  @PY-RPSE-002 @session @navigation @trace=REQ-RPSE-002
  ...
  @PY-RPSE-003 @session @stability @trace=REQ-RPSE-003
  ...
  @PY-RPSE-004 @session @positive @trace=REQ-RPSE-004
