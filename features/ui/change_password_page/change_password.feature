...
Feature: OpenCart Account - Change Password
  ...
  @PAS-7 @PY-CP-001 @smoke @trace=REQ-CP-001
  ...
  @PAS-10 @PY-CP-002 @smoke @trace=REQ-CP-002
  ...
  @PAS-11 @PY-CP-003 @negative @trace=REQ-CP-003
  ...
  @PAS-5 @PY-CP-004 @negative @trace=REQ-CP-004
  ...
  @PAS-9 @PY-CP-005 @negative @trace=REQ-CP-005
  ...
  @PAS-6 @PY-CP-006 @validation @trace=REQ-CP-006
  ...
  @PAS-8 @PY-CP-007 @validation @trace=REQ-CP-007
  ...
  @PAS-12 @PY-CP-008 @navigation @trace=REQ-CP-008
