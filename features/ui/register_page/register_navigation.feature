...
Feature: OpenCart Authentication - Register Page Navigation
  ...
  @PY-RPN-001 @smoke @trace=REQ-RPN-001
  ...
  @PY-RPN-002 @navigation @trace=REQ-RPN-002
  ...
  @PY-RPN-005 @navigation @trace=REQ-RPN-005
  ...
  @PY-RPN-006 @navigation @trace=REQ-RPN-006
