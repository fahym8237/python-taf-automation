...
Feature: Booking API - CRUD
  ...
  @PAS-4 @smoke @trace=REQ-BOOKING-CRUD-001
  ...
  @PAS-1 @smoke @trace=REQ-BOOKING-CRUD-001
  ...
  @PAS-2 @smoke @trace=REQ-BOOKING-CRUD-001
  ...
  @PAS-3 @smoke @trace=REQ-BOOKING-CRUD-001
