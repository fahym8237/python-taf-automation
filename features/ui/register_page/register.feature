...
Feature: OpenCart Authentication - Register Page
  ...
  @PAS-100 @PY-RP-001 @smoke @trace=REQ-RP-001
  ...
  @PAS-98 @PY-RP-002 @positive @trace=REQ-RP-002
  ...
  @PAS-95 @PY-RP-003 @negative @trace=REQ-RP-003
  ...
  @PAS-97 @PY-RP-006 @validation @trace=REQ-RP-006
  ...
  @PAS-101 @ui @register_page @data_driven @trace=REQ-RP-007
