...
Feature: OpenCart Authentication - Login Page Navigation
  ...
  @PAS-76 @PY-LPN-001 @smoke @trace=REQ-LPN-001
  ...
  @PAS-78 @PY-LPN-002 @smoke @trace=REQ-LPN-002
  ...
  @PAS-74 @PY-LPN-003 @navigation @trace=REQ-LPN-003
  ...
  @PAS-77 @PY-LPN-004 @navigation @trace=REQ-LPN-004
  ...
  @PAS-75 @PY-LPN-005 @navigation @trace=REQ-LPN-005
  ...
  @PAS-79 @PY-LPN-006 @navigation @trace=REQ-LPN-006
